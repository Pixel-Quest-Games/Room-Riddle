...
export default class enigmafinal extends Phaser.Scene {
  constructor () {
    super('enigma_final')
  }
      ...
      item.botao = this.add.image(item.x, item.y, 'buttom_down')
        ...
        .on('pointerdown', () => {
          ...
          if (this.game.verifica_enigmaf_m === 'F') {
            ...
            if (this.verificacao1 === 'V' && this.verificacao2 === 'V' && this.verificacao3 === 'V' && this.verificacao4 === 'V' && this.game.verifica_enigma12 === 'V') {
              console.log('foi meu')
